<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_plan.aspx.cs" Inherits="bas_edit_plan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 var dfx_str = "#show_searchopenyhbspgogo_cpbh";
                     ...
                     if ($(dfx_str).text() != oldzhi)
                     {
                         ...
                         if (arr != null) {//如果能匹配成功即arr数组不为空，循环输出结果
                             for (var i = 0; i < arr.length; i++) {
                                 ...
                                 if (arr_z[0] == "[产品单位B")
                                 { $("#jhfldw").val($.trim(arr_z[1]).replace("]", "")); }
                             }
                         }
