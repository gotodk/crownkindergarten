<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_chuku.aspx.cs" Inherits="ckck_edit_chuku" %>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
                 ...
                 window.setInterval(function () {
                     ...
                     //设置子表输入框只读
                     $("#gview_grid-table-subtable-160922000235").find("input").attr("readonly", "readonly");
                     $("#gview_grid-table-subtable-160922000235").find("input[name='出库数量']").removeAttr("readonly");
                     //$("#gview_grid-table-subtable-160922000235").find("input[name='批号']").removeAttr("readonly");

                     if (getUrlParam("fff") == "1" && (getUrlParam("showinfo") == "1" || getUrlParam("showinfo") == "2")) {

                         var obj = $("#grid-table-subtable-160922000235").jqGrid("getRowData");

                         if (obj.length > 0) {
                             jQuery(obj).each(function () {
                                 if (this.出库库位.length < 50) {
