<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_ruku.aspx.cs" Inherits="ckck_edit_ruku" %>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
                 ...
                 window.setInterval(function () {
                     ...
                     //设置子表输入框只读
                     $("#gview_grid-table-subtable-160922000248").find("input").attr("readonly", "readonly");
                     $("#gview_grid-table-subtable-160922000248").find("input[name='入库数量']").removeAttr("readonly");
                     $("#gview_grid-table-subtable-160922000248").find("input[name='批号']").removeAttr("readonly");

                     $("#gview_grid-table-subtable-160922000248").find("input[name='名称']").removeAttr("readonly");
                     $("#gview_grid-table-subtable-160922000248").find("input[name='规格']").removeAttr("readonly");
                     $("#gview_grid-table-subtable-160922000248").find("input[name='单位']").removeAttr("readonly");

                     if (getUrlParam("fff") == "1" && (getUrlParam("showinfo") == "1" || getUrlParam("showinfo") == "2")) {

                         var obj = $("#grid-table-subtable-160922000248").jqGrid("getRowData");
